...
if uploaded_file is not None:
    ...
    if selected_product:
        ...
        if not filtered_data.empty:
            ...
            filtered_data['sentiments'] = filtered_data['reviewText'].apply(lambda x: sia.polarity_scores(x)['compound'])
            ...
            sentiment_summary = "Positive" if positive_count > negative_count else "Negative" if negative_count > positive_count else "Mixed"
            ...
            wordcloud = WordCloud(width=800, height=400).generate(' '.join(filtered_data['reviewText']))
